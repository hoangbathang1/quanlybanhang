				...
				<div class="tile-body">
					<div class="row element-button">
						<div class="col-sm-2">
							...
							<a class="btn btn-add btn-sm" href="${pageContext.request.contextPath}/admin/danhmuc/them"
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									<a class="btn btn-primary btn-sm trash" href="${pageContext.request.contextPath}/admin/danhmuc/xoa/${item.id }"><i class="fas fa-trash-alt"></i></a>
										 <a class="btn btn-primary btn-sm edit" href="${pageContext.request.contextPath}/admin/danhmuc/sua/${item.id }"><i class="fas fa-edit"></i></a>
